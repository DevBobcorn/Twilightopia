...
public final class ModItemGroups {
	...
	public static final ItemGroup TWILIGHT_WORLD_GROUP = new ModItemGroup("twilightopia_world", () -> new ItemStack(ModItems.lodge_herb));
	...
	public static final ItemGroup TWILIGHT_FOOD_GROUP = new ModItemGroup("twilightopia_food", () -> new ItemStack(ModItems.chocolate_bar));
