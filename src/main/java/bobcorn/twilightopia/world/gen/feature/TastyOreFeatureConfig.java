...
public class TastyOreFeatureConfig implements IFeatureConfig {
   public final TastyOreFeatureConfig.FillerBlockType target;
   public final int size;
   public final BlockState state;

   public TastyOreFeatureConfig(TastyOreFeatureConfig.FillerBlockType target, BlockState state, int size) {
      this.size = size;
      this.state = state;
      this.target = target;
   }
   ...
   public static TastyOreFeatureConfig deserialize(Dynamic<?> p_214641_0_) {
      int i = p_214641_0_.get("size").asInt(0);
      TastyOreFeatureConfig.FillerBlockType orefeatureconfig$fillerblocktype = TastyOreFeatureConfig.FillerBlockType.func_214736_a(p_214641_0_.get("target").asString(""));
      BlockState blockstate = p_214641_0_.get("state").map(BlockState::deserialize).orElse(Blocks.AIR.getDefaultState());
      return new TastyOreFeatureConfig(orefeatureconfig$fillerblocktype, blockstate, i);
   }
   ...
   public static enum FillerBlockType {
      ...
      CHEESE("cheese", new BlockMatcher(ModBlocks.CHEESE_BLOCK));

      private static final Map<String, TastyOreFeatureConfig.FillerBlockType> field_214741_c = Arrays.stream(values()).collect(Collectors.toMap(TastyOreFeatureConfig.FillerBlockType::func_214737_a, (p_214740_0_) -> {
         return p_214740_0_;
      }));
      ...
      public static TastyOreFeatureConfig.FillerBlockType func_214736_a(String p_214736_0_) {
