...
public class WallSignPlusBlock extends AbstractSignPlusBlock {
   ...
   public WallSignPlusBlock(Block.Properties properties) {
      super(properties);
   ...
   public String getTranslationKey() {
      return this.asItem().getTranslationKey();
	   //return "block." + TwilightopiaMod.MODID + ".sign_plus";
   }
