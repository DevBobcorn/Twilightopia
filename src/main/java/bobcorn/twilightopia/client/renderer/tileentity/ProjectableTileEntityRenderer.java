...
import static bobcorn.twilightopia.client.renderer.ProjectableMapModel.BLOCK_RENDER_LAYERS;
...
public class ProjectableTileEntityRenderer extends TileEntityRenderer<ProjectableTileEntity> {
	 ...
	 */
	@Override
	public void render(final ProjectableTileEntity tileEntityIn, final double x, final double y, final double z, final float partialTicks, final int destroyStage) {
