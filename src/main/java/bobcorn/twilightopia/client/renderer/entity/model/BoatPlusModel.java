...
@OnlyIn(Dist.CLIENT)
public class BoatPlusModel extends EntityModel<BoatPlusEntity> {
   ...
   public BoatPlusModel() {
      this.body[0] = (new RendererModel(this, 0, 0)).setTextureSize(128, 64);
      this.body[1] = (new RendererModel(this, 0, 19)).setTextureSize(128, 64);
      this.body[2] = (new RendererModel(this, 0, 27)).setTextureSize(128, 64);
      this.body[3] = (new RendererModel(this, 0, 35)).setTextureSize(128, 64);
      this.body[4] = (new RendererModel(this, 0, 43)).setTextureSize(128, 64);
      ...
      this.body[0].rotateAngleX = ((float)Math.PI / 2F);
      this.body[1].rotateAngleY = ((float)Math.PI * 1.5F);
      this.body[2].rotateAngleY = ((float)Math.PI / 2F);
      this.body[3].rotateAngleY = (float)Math.PI;
   ...
   public void render(BoatPlusEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
   ...
   protected void renderPaddle(BoatPlusEntity boat, int paddle, float scale, float limbSwing) {
