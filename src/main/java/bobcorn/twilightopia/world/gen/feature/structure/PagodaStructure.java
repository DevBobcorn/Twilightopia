...
public class PagodaStructure extends TwilitTemplateStructure<NoFeatureConfig> {
	public PagodaStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
