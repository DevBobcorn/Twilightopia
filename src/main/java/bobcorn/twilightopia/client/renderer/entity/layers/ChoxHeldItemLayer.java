...
@OnlyIn(Dist.CLIENT)
public class ChoxHeldItemLayer extends LayerRenderer<ChoxEntity, FoxModel<ChoxEntity>> {
   public ChoxHeldItemLayer(IEntityRenderer<ChoxEntity, FoxModel<ChoxEntity>> p_i50938_1_) {
      super(p_i50938_1_);
   }
