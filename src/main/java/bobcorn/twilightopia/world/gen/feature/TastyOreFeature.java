...
public class TastyOreFeature extends Feature<TastyOreFeatureConfig> {
   public TastyOreFeature(Function<Dynamic<?>, ? extends TastyOreFeatureConfig> p_i51472_1_) {
      super(p_i51472_1_);
   }

   public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, TastyOreFeatureConfig config) {
   ...
   protected boolean func_207803_a(IWorld worldIn, Random random, TastyOreFeatureConfig config, double p_207803_4_, double p_207803_6_, double p_207803_8_, double p_207803_10_, double p_207803_12_, double p_207803_14_, int p_207803_16_, int p_207803_17_, int p_207803_18_, int p_207803_19_, int p_207803_20_) {
      int i = 0;
